...
public class GOTModelDragon extends ModelBase {
	...
	public GOTModelDragon(GOTDragonBreed breed, ResourceLocation bodyTexture, ResourceLocation glowTexture, ResourceLocation saddleTexture, ResourceLocation eggTexture) {
		textureWidth = 256;
		textureHeight = 256;
