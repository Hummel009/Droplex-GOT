...
public class GOTRender {
	...
	public static void onInit() {
		...
		renders.put(GOTEntityDragon1.class, new GOTRenderDragon1());
		renders.put(GOTEntityDragon2.class, new GOTRenderDragon2());
		renders.put(GOTEntityDragon3.class, new GOTRenderDragon3());
		renders.put(GOTEntityDragon4.class, new GOTRenderDragon4());
		renders.put(GOTEntityDragon5.class, new GOTRenderDragon5());
		renders.put(GOTEntityDragon6.class, new GOTRenderDragon6());
		renders.put(GOTEntityDragon7.class, new GOTRenderDragon7());
		renders.put(GOTEntityDragon8.class, new GOTRenderDragon8());
		renders.put(GOTEntityDragon9.class, new GOTRenderDragon9());
		renders.put(GOTEntityDragon10.class, new GOTRenderDragon10());
		renders.put(GOTEntityDragon11.class, new GOTRenderDragon11());
		renders.put(GOTEntityDragon12.class, new GOTRenderDragon12());
		renders.put(GOTEntityDragon13.class, new GOTRenderDragon13());
