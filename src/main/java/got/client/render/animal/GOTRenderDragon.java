...
public class GOTRenderDragon extends RenderLiving {
	...
	public ResourceLocation eggObj = new ResourceLocation("got:textures/entity/animal/dragon/egg.obj");

	public IModelCustom egg = AdvancedModelLoader.loadModel(eggObj);
	...
	public ResourceLocation getEggTexture() {
		return new ResourceLocation("got:textures/entity/animal/dragon/egg.png");
	}

	public ResourceLocation getSaddleTexture() {
		return new ResourceLocation("got:textures/entity/animal/dragon/saddle.png");
	}

	public ResourceLocation getGlowTexture() {
		return new ResourceLocation("got:textures/entity/animal/dragon/glow.png");
	}

	public ResourceLocation getBodyTexture() {
		return new ResourceLocation("got:textures/entity/animal/dragon/body.png");
	}
	...
	public void initBreedModels() {
		...
		for (GOTDragonBreed breed : GOTDragonBreedRegistry.getInstance().getBreeds()) {
			stages.put(breed, new GOTModelDragon(breed, getBodyTexture(), getGlowTexture(), getSaddleTexture(), getEggTexture()));
		}
	}
