...
public class GOTTileEntityAlloyForge extends TileEntity implements ISidedInventory {
	...
	public ItemStack getAlloySmeltingResult(ItemStack itemstack, ItemStack alloyItem) {
		...
		if (isBronze(itemstack) && isIron(alloyItem) || isIron(itemstack) && isBronze(alloyItem)) {
			return new ItemStack(GOTItems.superIngot);
		}
		if (isSuperIngot(itemstack) && isAlloySteelIngot(alloyItem) || isAlloySteelIngot(itemstack) && isSuperIngot(alloyItem)) {
			return new ItemStack(GOTItems.superIngotTop);
		}
		if (isLeatherString(itemstack) && isCoal(alloyItem) || isCoal(itemstack) && isLeatherString(alloyItem)) {
			return new ItemStack(GOTItems.leatherCooked);
		}
		return null;
	}
	...
	public boolean isAlloySteelIngot (ItemStack itemstack) {
		return itemstack.getItem() == GOTItems.alloySteelIngot;
	}
	public boolean isBronze(ItemStack itemstack) {
		return itemstack.getItem() == GOTItems.bronzeIngot;
	}
	public boolean isSuperIngot(ItemStack itemstack) {
		return itemstack.getItem() == GOTItems.superIngot;
	}
	public boolean isSuperIngotTop(ItemStack itemstack) {
		return itemstack.getItem() == GOTItems.superIngotTop;
	}
	public boolean isLeatherString(ItemStack itemstack) {
		return itemstack.getItem() == GOTItems.leatherString;
	}
