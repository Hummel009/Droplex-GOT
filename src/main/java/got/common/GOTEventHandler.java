...
public class GOTEventHandler implements IFuelHandler {
	...
	public void onCrafting(ItemCraftedEvent event) {
		...
		if (!entityplayer.worldObj.isRemote) {
			...
			if (itemstack.getItem() == Item.getItemFromBlock(GOTBlocks.wildFireJar)) {
				...
				if (itemstack.getItem() == GOTItems.superIngot) {
					GOTLevelData.getData(entityplayer).addAchievement(GOTAchievement.GET_SUPERINGOT);
				}
				if (itemstack.getItem() == GOTItems.superIngotTop) {
					GOTLevelData.getData(entityplayer).addAchievement(GOTAchievement.GET_SUPERINGOTTOP);
				}
				if (itemstack.getItem() == GOTItems.dorneSpear) {
					GOTLevelData.getData(entityplayer).addAchievement(GOTAchievement.GET_DORNESPEAR);
				}
				if (itemstack.getItem() == GOTItems.stormlandsHammer) {
					GOTLevelData.getData(entityplayer).addAchievement(GOTAchievement.GET_STORMLANDSHAMMER);
				}
				if (itemstack.getItem() == GOTItems.reachSword) {
					GOTLevelData.getData(entityplayer).addAchievement(GOTAchievement.GET_REACHSWORD);
				}
				if (itemstack.getItem() == GOTItems.arrynPike) {
					GOTLevelData.getData(entityplayer).addAchievement(GOTAchievement.GET_ARRYNPIKE);
				}
				if (itemstack.getItem() == GOTItems.crownlandsSword) {
					GOTLevelData.getData(entityplayer).addAchievement(GOTAchievement.GET_CROWNLANDSSWORD);
				}
				if (itemstack.getItem() == GOTItems.northBattleAxe) {
					GOTLevelData.getData(entityplayer).addAchievement(GOTAchievement.GET_NORTHBATTLEAXE);
				}
				if (itemstack.getItem() == GOTItems.ironbornAxe) {
					GOTLevelData.getData(entityplayer).addAchievement(GOTAchievement.GET_IRONBORNAXE);
				}
				if (itemstack.getItem() == GOTItems.riverlandsBow) {
					GOTLevelData.getData(entityplayer).addAchievement(GOTAchievement.GET_RIVERLANDSBOW);
				}
				if (itemstack.getItem() == GOTItems.westerlandsCrossbow) {
					GOTLevelData.getData(entityplayer).addAchievement(GOTAchievement.GET_WESTERLANDSCROSSBOW);
				}
				if (itemstack.getItem() == GOTItems.dragonstoneTorch) {
					GOTLevelData.getData(entityplayer).addAchievement(GOTAchievement.GET_DRAGONSTONETORCH);
				}
				if (itemstack.getItem() == GOTItems.superBow) {
					GOTLevelData.getData(entityplayer).addAchievement(GOTAchievement.GET_SUPERBOW);
				}
	...
	public void onPlayerInteract(PlayerInteractEvent evt) {
		...
		extracted(evt, block, world, new GOTEntityDragon1(world), GOTBlocks.dragonEgg1);
		extracted(evt, block, world, new GOTEntityDragon2(world), GOTBlocks.dragonEgg2);
		extracted(evt, block, world, new GOTEntityDragon3(world), GOTBlocks.dragonEgg3);
		extracted(evt, block, world, new GOTEntityDragon4(world), GOTBlocks.dragonEgg4);
		extracted(evt, block, world, new GOTEntityDragon5(world), GOTBlocks.dragonEgg5);
		extracted(evt, block, world, new GOTEntityDragon6(world), GOTBlocks.dragonEgg6);
		extracted(evt, block, world, new GOTEntityDragon7(world), GOTBlocks.dragonEgg7);
		extracted(evt, block, world, new GOTEntityDragon8(world), GOTBlocks.dragonEgg8);
		extracted(evt, block, world, new GOTEntityDragon9(world), GOTBlocks.dragonEgg9);
		extracted(evt, block, world, new GOTEntityDragon10(world), GOTBlocks.dragonEgg10);
		extracted(evt, block, world, new GOTEntityDragon11(world), GOTBlocks.dragonEgg11);
		extracted(evt, block, world, new GOTEntityDragon12(world), GOTBlocks.dragonEgg12);
		extracted(evt, block, world, new GOTEntityDragon13(world), GOTBlocks.dragonEgg13);
	}

	private static void extracted(PlayerInteractEvent evt, Block block, World world, GOTEntityDragon dragon, Block egg) {
		if (block == egg) {
