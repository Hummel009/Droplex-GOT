...
public class GOTConfig {
    ...
    public static int getDragonFireballCooldown;
    ...
    public static void load() {
        renderspecial = config.get(CATEGORY_GAMEPLAY, "Special Render", true, "Disable renders to prevent crashes").getBoolean();
        getDragonFireballCooldown = config.get(CATEGORY_GAMEPLAY, "Dragon fireball cooldown time (in seconds)", 30).getInt();
