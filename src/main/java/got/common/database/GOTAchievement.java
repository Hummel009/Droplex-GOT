...
public class GOTAchievement {
	...
	public static GOTAchievement WEAR_FULL_HEAVYARMOR_RIVERLANDS;
	public static GOTAchievement WEAR_FULL_HEAVYARMOR_HORTH;
	public static GOTAchievement WEAR_FULL_HEAVYARMOR_ARRYN;
	public static GOTAchievement WEAR_FULL_HEAVYARMOR_CROWNLANDS;
	public static GOTAchievement WEAR_FULL_HEAVYARMOR_REACH;
	public static GOTAchievement WEAR_FULL_HEAVYARMOR_STORMLANDS;
	public static GOTAchievement WEAR_FULL_HEAVYARMOR_IRONBORN;
	public static GOTAchievement WEAR_FULL_HEAVYARMOR_DORNE;
	public static GOTAchievement WEAR_FULL_HEAVYARMOR_DRAGONSTONE;
	public static GOTAchievement WEAR_FULL_HEAVYARMOR_GHISCAR;
	public static GOTAchievement WEAR_FULL_HEAVYARMOR_ESOS;
	public static GOTAchievement WEAR_FULL_HEAVYARMOR_WESTERLANDS;
	public static GOTAchievement GET_SUPERINGOT;
	public static GOTAchievement GET_SUPERINGOTTOP;
	public static GOTAchievement GET_DORNESPEAR;
	public static GOTAchievement GET_NORTHBATTLEAXE;
	public static GOTAchievement GET_RIVERLANDSBOW;
	public static GOTAchievement GET_CROWNLANDSSWORD;
	public static GOTAchievement GET_DRAGONSTONETORCH;
	public static GOTAchievement GET_ARRYNPIKE;
	public static GOTAchievement GET_IRONBORNAXE;
	public static GOTAchievement GET_WESTERLANDSCROSSBOW;
	public static GOTAchievement GET_REACHSWORD;
	public static GOTAchievement GET_STORMLANDSHAMMER;
	public static GOTAchievement GET_SUPERBOW;
	...
	public static void onInit() {
		...
		doLegendaryQuest = new GOTAchievement(Category.GENERAL, id++, GOTBlocks.dragonEgg7, "DO_LEGENDARY_QUEST");
		...
		killDaenerysTargaryen = new GOTAchievement(Category.LEGENDARY, id++, GOTBlocks.dragonEgg13, "KILL_DAENERYS_TARGARYEN").createTitle();
		...
		killKraznysMoNakloz = new GOTAchievement(Category.LEGENDARY, id++, GOTBlocks.dragonEgg1, "KILL_KRAZNYS_MO_NAKLOZ");
		...
		GET_SUPERBOW = new GOTAchievement(Category.GENERAL, id++, GOTItems.superBow, "GET_SUPERBOW");
		GET_NORTHBATTLEAXE = new GOTAchievement(Category.GENERAL, id++, GOTItems.northBattleAxe, "GET_NORTHBATTLEAXE");
		GET_RIVERLANDSBOW = new GOTAchievement(Category.GENERAL, id++, GOTItems.riverlandsBow, "GET_RIVERLANDSBOW");
		GET_CROWNLANDSSWORD = new GOTAchievement(Category.GENERAL, id++, GOTItems.crownlandsSword, "GET_CROWNLANDSSWORD");
		GET_DRAGONSTONETORCH = new GOTAchievement(Category.GENERAL, id++, GOTItems.dragonstoneTorch, "GET_DRAGONSTONETORCH");
		GET_ARRYNPIKE = new GOTAchievement(Category.GENERAL, id++, GOTItems.arrynPike, "GET_ARRYNPIKE");
		GET_IRONBORNAXE = new GOTAchievement(Category.GENERAL, id++, GOTItems.ironbornAxe, "GET_IRONBORNAXE");
		GET_WESTERLANDSCROSSBOW = new GOTAchievement(Category.GENERAL, id++, GOTItems.westerlandsCrossbow, "GET_WESTERLANDSCROSSBOW");
		GET_REACHSWORD = new GOTAchievement(Category.GENERAL, id++, GOTItems.reachSword, "GET_REACHSWORD");
		GET_STORMLANDSHAMMER = new GOTAchievement(Category.GENERAL, id++, GOTItems.stormlandsHammer, "GET_STORMLANDSHAMMER");
		GET_DORNESPEAR = new GOTAchievement(Category.GENERAL, id++, GOTItems.dorneSpear, "GET_DORNESPEAR");
		WEAR_FULL_HEAVYARMOR_RIVERLANDS = GOTAchievement.createArmorAchievement(Category.WEAR, id++, GOTItems.riverlandsHeavyChestplate, "WEAR_FULL_HEAVYARMOR_RIVERLANDS");
		WEAR_FULL_HEAVYARMOR_HORTH = GOTAchievement.createArmorAchievement(Category.WEAR, id++, GOTItems.northHeavyChestplate, "WEAR_FULL_HEAVYARMOR_NORTH");
		WEAR_FULL_HEAVYARMOR_ARRYN = GOTAchievement.createArmorAchievement(Category.WEAR, id++, GOTItems.arrynHeavyChestplate, "WEAR_FULL_HEAVYARMOR_ARRYN");
		WEAR_FULL_HEAVYARMOR_CROWNLANDS = GOTAchievement.createArmorAchievement(Category.WEAR, id++, GOTItems.crownlandsHeavyChestplate, "WEAR_FULL_HEAVYARMOR_CROWNLANDS");
		WEAR_FULL_HEAVYARMOR_REACH = GOTAchievement.createArmorAchievement(Category.WEAR, id++, GOTItems.reachHeavyChestplate, "WEAR_FULL_HEAVYARMOR_REACH");
		WEAR_FULL_HEAVYARMOR_STORMLANDS = GOTAchievement.createArmorAchievement(Category.WEAR, id++, GOTItems.stormlandsHeavyChestplate, "WEAR_FULL_HEAVYARMOR_STORMLANDS");
		WEAR_FULL_HEAVYARMOR_IRONBORN = GOTAchievement.createArmorAchievement(Category.WEAR, id++, GOTItems.ironbornHeavyChestplate, "WEAR_FULL_HEAVYARMOR_IRONBORN");
		WEAR_FULL_HEAVYARMOR_DORNE = GOTAchievement.createArmorAchievement(Category.WEAR, id++, GOTItems.dorneHeavyChestplate, "WEAR_FULL_HEAVYARMOR_DORNE");
		WEAR_FULL_HEAVYARMOR_DRAGONSTONE = GOTAchievement.createArmorAchievement(Category.WEAR, id++, GOTItems.dragonstoneHeavyChestplate, "WEAR_FULL_HEAVYARMOR_DRAGONSTONE");
		WEAR_FULL_HEAVYARMOR_GHISCAR = GOTAchievement.createArmorAchievement(Category.WEAR, id++, GOTItems.ghiscarHeavyChestplate, "WEAR_FULL_HEAVYARMOR_GHISCAR");
		WEAR_FULL_HEAVYARMOR_ESOS = GOTAchievement.createArmorAchievement(Category.WEAR, id++, GOTItems.esosHeavyChestplate, "WEAR_FULL_HEAVYARMOR_ESOS");
		WEAR_FULL_HEAVYARMOR_WESTERLANDS = GOTAchievement.createArmorAchievement(Category.WEAR, id++, GOTItems.westerlandsHeavyChestplate, "WEAR_FULL_HEAVYARMOR_WESTERLANDS");
