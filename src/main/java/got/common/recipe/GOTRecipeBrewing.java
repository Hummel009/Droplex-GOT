...
public class GOTRecipeBrewing {
	...
	public static void onInit() {
		...
		addBrewingRecipe(new ItemStack(GOTItems.mugUnsulliedTonic, BARREL_CAPACITY), GOTBlocks.boneBlock, GOTBlocks.boneBlock, GOTBlocks.boneBlock, GOTBlocks.boneBlock, GOTBlocks.boneBlock, GOTBlocks.boneBlock);
		...
		addBrewingRecipe(new ItemStack(GOTItems.mugPlantainBrew, BARREL_CAPACITY), GOTItems.concentratePlantain, GOTItems.concentratePlantain, GOTItems.concentratePlantain, GOTItems.concentratePlantain, GOTItems.concentratePlantain, GOTItems.concentratePlantain);
		...
		addBrewingRecipe(new ItemStack(GOTItems.mugPoppyMilk, BARREL_CAPACITY), GOTItems.concentratePoppy, GOTItems.concentratePoppy, GOTItems.concentratePoppy, GOTItems.concentratePoppy, GOTItems.concentratePoppy, GOTItems.concentratePoppy);
		...
		addBrewingRecipe(new ItemStack(GOTItems.mugCocoa, BARREL_CAPACITY), new ItemStack(Items.dye, 1, 3), new ItemStack(Items.dye, 1, 3), new ItemStack(Items.dye, 1, 3), new ItemStack(Items.dye, 1, 3), new ItemStack(Items.dye, 1, 3), new ItemStack(Items.dye, 1, 3));
	}
}