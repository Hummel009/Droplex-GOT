...
public enum GOTWaypoint implements GOTAbstractWaypoint {
	ItsNotYours(Region.RIVERLANDS, GOTFaction.UNALIGNED,  819, 1493),
	...
	Anogaria(Region.FREE, GOTFaction.VOLANTIS, 1771, 2014), 
	Antlers(Region.CROWNLANDS, GOTFaction.CROWNLANDS, 789, 1534),
