...
public class GOTItemVexSword extends ItemSword implements GOTMaterialFinder {
	...
	public GOTItemVexSword(Item.ToolMaterial material) {
		super(material);
	...
	public GOTItemVexSword(Item.ToolMaterial material, HitEffect e) {
		this(material);
		effect = e;
	}
	...
	public GOTItemVexSword setIsGlowing() {
		isGlowing = true;
		return this;
	}
