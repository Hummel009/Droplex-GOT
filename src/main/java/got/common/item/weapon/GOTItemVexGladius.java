...
public class GOTItemVexGladius extends ItemSword implements GOTMaterialFinder {
	...
	public GOTItemVexGladius(Item.ToolMaterial material) {
		super(material);
	...
	public GOTItemVexGladius(Item.ToolMaterial material, HitEffect e) {
		this(material);
		effect = e;
	}
	...
	public GOTItemVexGladius setIsGlowing() {
		isGlowing = true;
		return this;
	}
