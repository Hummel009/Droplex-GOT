...
public class GOTItemVexCrossbow extends ItemBow {
	...
	public static float getCrossbowLaunchSpeedFactor(ItemStack itemstack) {
		float f = 1.0f;
		if (itemstack != null) {
			if (itemstack.getItem() instanceof GOTItemVexCrossbow) {
				f = (float) (f * ((GOTItemVexCrossbow) itemstack.getItem()).boltDamageFactor);
			}
	...
	public static ItemStack getLoaded(ItemStack itemstack) {
		if (itemstack != null && itemstack.getItem() instanceof GOTItemVexCrossbow) {
