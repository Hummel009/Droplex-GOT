...
public class GOTItemVexTorch extends ItemSword implements GOTMaterialFinder {
	...
	public GOTItemVexTorch(Item.ToolMaterial material) {
		super(material);
	...
	public GOTItemVexTorch(Item.ToolMaterial material, HitEffect e) {
		this(material);
		effect = e;
	}
	...
	public GOTItemVexTorch setIsGlowing() {
		isGlowing = true;
		return this;
	}
