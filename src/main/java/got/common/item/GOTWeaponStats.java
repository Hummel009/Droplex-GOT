...
public class GOTWeaponStats {
	...
	static {
		registerMeleeSpeed(GOTItemVexHammer.class, 0.578f);
		registerMeleeReach(GOTItemVexHammer.class, 1.15f);	
		registerMeleeSpeed(GOTItemVexTorch.class, 0.55f);
		registerMeleeReach(GOTItemVexTorch.class, 1.05f);	
		registerMeleeSpeed(GOTItemVexAxe.class, 1.145f);
		registerMeleeReach(GOTItemVexAxe.class, 0.866f);	
		registerMeleeSpeed(GOTItemVexPike.class, 0.6f);
		registerMeleeReach(GOTItemVexPike.class, 2f);	
		registerMeleeSpeed(GOTItemVexBattleAxe.class, 0.55f);
		registerMeleeReach(GOTItemVexBattleAxe.class, 1.25f);	
		registerMeleeSpeed(GOTItemVexSword.class, 1.0f);
		registerMeleeReach(GOTItemVexSword.class, 1.1f);	
		registerMeleeSpeed(GOTItemVexGladius.class, 1.5f);
		registerMeleeReach(GOTItemVexGladius.class, 0.85f);	
		registerMeleeSpeed(GOTItemVexSpear.class, 0.9f);
		registerMeleeReach(GOTItemVexSpear.class, 1.5f);	
		registerMeleeSpeed(GOTItemGreatsword.class, 1f);
		registerMeleeSpeed(GOTItemLongsword.class, 1f);
		registerMeleeReach(GOTItemGreatsword.class, 1f);
		registerMeleeReach(GOTItemLongsword.class, 1f);
		...
		registerMeleeExtraKnockback(GOTItemVexBattleAxe.class, 1);
		registerMeleeExtraKnockback(GOTItemVexPike.class, 1);
		registerMeleeExtraKnockback(GOTItemVexHammer.class, 2);
	}
