...
public class GOTFactionRelations {
	public static Map<FactionPair, Relation> defaultMap = new HashMap<FactionPair, Relation>();
	public static Map<FactionPair, Relation> overrideMap = new HashMap<FactionPair, Relation>();
	...
	public enum Relation {
		...
		public String getDisplayName() {
			return StatCollector.translateToLocal("got.faction.rel." + this.codeName());
		}
	}
	...
	public static class FactionPair {
		...
		public boolean equals(Object obj) {
			...
			if (obj instanceof FactionPair) {
				...
				return this.fac1 == pair.fac1 && this.fac2 == pair.fac2 || this.fac1 == pair.fac2 && this.fac2 == pair.fac1;
			}
			return false;
		}
